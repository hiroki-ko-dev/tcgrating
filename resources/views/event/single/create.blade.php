                  ...
                  @else
                    ...
                    <div class="card-body">
                      <div class="d-flex flex-row mb-3">
                        ...
                        <div class="w-70">
                          <input id="tool_id" type="number" placeholder="※後から編集できます" class="form-control w-100 @error('tool_id') is-invalid @enderror" name="tool_id" value="{{ old('tool_id') }}" required autocomplete="tool_id" autofocus>
                          @error('tool_id')
                          <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>

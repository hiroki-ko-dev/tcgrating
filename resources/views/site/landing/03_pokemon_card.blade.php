        ...
        <div class="box">
          ...
          <div class="d-flex flex-row mb-3">
            <div class="w-50 rounded m-1 pb-2">
              <a href="https://apps.apple.com/us/app/tcgrating/id1620838810?itsct=apps_box_link&itscg=30200">
                <img class="img-fluid iphone" src="{{ asset('/images/site/landing/iphone_download.png') }}" alt="hashimu-icon">
              </a>
            </div>
            <div class="w-50 rounded m-1 pb-2">
              <a href="https://play.google.com/store/apps/details?id=hashimu.tcgrating&hl=ja">
